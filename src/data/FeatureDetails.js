const Features = {
	race: {
		...
		'half-elf versatility':
			'**Choose one of the following traits: Skill Veratility (General), Elf Weapon Training (High or Wood Elf Heritage), Cantrip (High Elf Heritage), Fleet of Foot (Wood Elf Heritage), Mask of the Wild (Wood Elf Heritage), Drow Magic (Dark Elf Heritage), or Swim Speed (Sea Elf Heritage)',
		'healing hands':
		...
		'kobold legacy':
			'Kobold Legacy. Kobolds’ connection to dragons can manifest in unpredictable ways in an individual kobold. Choose one of the following legacy options for your kobold: Craftiness, Defiance, Draconic Sorcery',
		...
		'merge with stone':
			'You know the Blade Ward cantrip. You can cast it as normal, and you can also cast it as a bonus action a number of times equal to your proficiency bonus, regaining all expended uses when you finish a long rest. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells when you cast them with this trait (choose when you select this race).',
		mimicry:
	...
	class: {
		...
		'brutal critical':
			'Beginning at 9th level, you can roll one additional weapon damage die when determining the extra damage for a critical hit with a melee attack./nThis increases to two additional dice at 13th level and three additional dice at 17th level.',
		countercharm:
		...
		'feral instinct':
			"By 7th level, your instincts are so honed that you have advantage on initiative rolls. /nAdditionally, if you are surprised at the beginning of combat and aren't incapacitated, you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.",
		'flash of genius':
